...
export default class ShopBar extends Component{
    ...
    settleAccouts(){
        // alert(JSON.stringify(this.props.lens)+"......"+JSON.stringify(this.props.seller)+"......"+JSON.stringify(this.props.list));
        this.props.navigator.push({
            component: SubmitOrder,
            args: {
                seller:this.props.seller,
                goods:this.props.list,
                order:this.props.lens,
            }
        })
    }
    render(){
        ...
        return (
            <View style={styles.cartView}>
                <View style={styles.cartBar}>
                    ...
                    {!lens.maxPrice || lens.maxPrice<this.props.seller.startPrice ?
                        <Text style={styles.price}>￥{this.props.seller.startPrice}元起</Text> :
                        <TouchableOpacity onPress={this.settleAccouts.bind(this)}>
